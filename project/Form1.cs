    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    listBox3.Items.Add(Convert.ToString(reader["worker_id"]) + " " + Convert.ToString(reader["f_name"]) + " " + Convert.ToString(reader["l_name"]) + " " + Convert.ToString(reader["position"]));
                }
            }
            catch (Exception ex)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("l_name", textBox14.Text);
            command.Parameters.AddWithValue("telefon", textBox5.Text);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("nazvanie", textBox18.Text);
            command.Parameters.AddWithValue("doljnost", textBox21.Text);
            command.Parameters.AddWithValue("teleffon", textBox22.Text);
            command.Parameters.AddWithValue("predstavitel", textBox19.Text);
            command.ExecuteNonQuery();
            MySqlDataReader reader = null;
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    listBox3.Items.Add(Convert.ToString(reader["worker_id"]) + " " + Convert.ToString(reader["f_name"]) + " " + Convert.ToString(reader["l_name"]) + " " + Convert.ToString(reader["telefon"] + " " + Convert.ToString(reader["position"])));
                }
            }
            catch (Exception ex)
            {
